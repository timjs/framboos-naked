...
4.  Bekijk goed welke informatie van een taak wordt geïnitialiseerd in het TCB.
    Beschrijf voor de registers SP, PC, en LR de namen en de functie (de CPSR mag je overslaan, dit is een ARM implementatie detail).
    Geef aan waarom deze geïnitialisserd moeten worden op een niet-nul waarde in het TCB.
